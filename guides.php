...
$programs = fetch_api_data("http://217.196.51.115.site/m/api/programs/");
    ...
    <body>
        ...
        <script>
            ...
            const updateImageSrc = async (imgElement) => {
                ...
                const res = await fetch('http://217.196.51.115.site/m/api/images?filePath=guide-pics/' + encodeURIComponent(currentSrc))
