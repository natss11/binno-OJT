...
<body class="bg-gray-100">
        ...
        <script>
            const loadImage<?php echo $id; ?> = async () => {
                ...
                const res = await fetch(
                    `http://binnostartup.site/m/api/images?filePath=<?php echo $filePath; ?>/${encodeURIComponent(currentSrc)}`
                );
    ...
    $companies = fetch_api_data("http://binnostartup.site/m/api/members/companies");
        ...
        <div class="container mx-auto p-8">
                ...
                <div class="container mx-auto sm:px-64">
                    ...
                    <div class="p-4 flex flex-col gap-4">
                        ...
                        <div id="eventsContent" class="ml-5">
                            ...
                            $events_url = "http://binnostartup.site/m/api/events/";
                        ...
                        <div id="postsContent" class="ml-5" style="display: none;">
                            ...
                            $posts_url = "http://binnostartup.site/m/api/posts/";
                            $member_id = $selected_company['member_id'];
                            ...
                            ?>
                                        <div class="bg-white border p-4 mb-4 mt-5 post-item <?php echo $post['post_category']; ?>" style="border-radius: 10px;">
                                            <div class="flex items-center">
                                                <img id="post_profile_pic_<?php echo $post['post_id']; ?>" src="<?php echo htmlspecialchars($selected_company['setting_profilepic']); ?>" alt="<?php echo htmlspecialchars(str_replace('profile-img/', '', $selected_company['setting_profilepic'])); ?>" class="w-16 h-16 object-cover rounded-full border">
                                                <div class="ml-4">
                                                    <h4 class="text-xl font-bold"><?php echo $selected_company['setting_institution']; ?></h4>
            ...
            <script>
                const loadImage = async () => {
                    ...
                    const res = await fetch(
                        `http://binnostartup.site/m/api/images?filePath=profile-img/${encodeURIComponent(currentSrc)}`
                    )
