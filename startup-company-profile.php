...
<body class="bg-gray-100">
    ...
    $companies = fetch_api_data("http://217.196.51.115.site/m/api/members/companies");
        ...
        <div class="container mx-auto p-8">
                ...
                <div class="container mx-auto sm:px-64">
                    ...
                    <div class="p-4 flex flex-col gap-4">
                        ...
                        <div id="postsContent" class="ml-5" style="display: none;">
                            ...
                            $posts_url = "http://217.196.51.115.site/m/api/posts/";
                            $member_id = $selected_company['member_id'];
            ...
            <script>
                const loadImage = async () => {
                    ...
                    const res = await fetch(
                        `http://217.196.51.115.site/m/api/images?filePath=profile-img/${encodeURIComponent(currentSrc)}`
                    )
