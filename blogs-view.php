...
$blogs = fetch_api_data("http://217.196.51.115.site/m/api/blogs/$blog_id");
$authors = fetch_api_data("http://217.196.51.115.site/m/api/members/enablers");
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const loadImage = async () => {
                    ...
                    const res = await fetch(
                        `http://217.196.51.115.site/m/api/images?filePath=blog-pics/${encodeURIComponent(currentSrc)}`
                    );
