...
$blogs = fetch_api_data("http://217.196.51.115/m/api/blogs/class/enabler");
...
?>
    ...
    <head>
        ...
        <title>BINNO | ENABLER BLOGS</title>
    </head>
        ...
        <main class="flex justify-center">
            <div class="container mx-16">
                <div>
                    ...
                    <h4 class="mt-5 font-bold text-3xl md:text-5xl">Enabler Blog Articles</h4>
                </div>
