...
$posts = fetch_api_data("http://binnostartup.site/m/api/posts/");
$events = fetch_api_data("http://binnostartup.site/m/api/events/");
            ...
            <div class="container mx-16">
                ...
                <div class="container mx-auto p-8 px-4 md:px-8 lg:px-16 flex flex-col md:flex-column">
                    ...
                    <script>
                        ...
                        async function updateImageSrc(imgSrc) {
                            imgSrc.src = `http://binnostartup.site/m/api/images?filePath=post-pics/${imgSrc.alt}`;
                            console.log(imgSrc);
                        }
                ...
                <div class="container mx-auto p-8 px-4 md:px-8 lg:px-16 flex flex-col md:flex-column">
                    ...
                    <script>
                        ...
                        // Function to fetch image data from API
                        async function updateImageSrc(imgSrc) {
                            imgSrc.src = `http://binnostartup.site/m/api/images?filePath=event-pics/${imgSrc.alt}`
                            console.log(imgSrc)
                        }
                ...
                <div class="container mx-auto p-8 px-4 md:px-8 lg:px-16 flex flex-col md:flex-column">
                    ...
                    <script>
                        ...
                        async function updateBlogImageSrc(imgSrc) {
                            imgSrc.src = `http://binnostartup.site/m/api/images?filePath=blog-pics/${imgSrc.alt}`;
                            console.log(imgSrc);
                        }
