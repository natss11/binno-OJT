    ...
    <body>
                        ...
                        ?>
                                <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                                    ...
                                    <div class="p-4 object-cover ml-5">
                                        ...
                                        <p class="text-gray-600 text-sm"><?php echo htmlspecialchars($post['post_dateadded']); ?></p>
                                    </div>
        ...
        <script>
            ...
            const updateImageSrc = async (imgElement) => {
                ...
                const res = await fetch('https://binnostartup.site/m/api/images?filePath=post-pics/' + encodeURIComponent(currentSrc))
