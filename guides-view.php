...
// Fetch program data
$api_url_programs = "http://217.196.51.115.site/m/api/programs/$program_id";
...
if (!$programs) {
    ...
    // Fetch enablers data
    $api_url_enablers = "http://217.196.51.115.site/m/api/members/enablers";
    ...
    <body>
            ...
            <div class="w-full lg:w-3/4 p-4 flex flex-col gap-4 mb-10" id="content-container">
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        // Automatically display the first program page
                        loadChapter(0);
                        // Apply CSS styling to the first link
                        document.querySelector('#chapter-list a').classList.add('active');
                    });
        ...
        <script>
            ...
            const updateImageSrc = async (imgElement) => {
                ...
                const res = await fetch('http://217.196.51.115.site/m/api/images?filePath=profile-img/' + encodeURIComponent(currentSrc))
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const loadImage = async () => {
                    ...
                    const res = await fetch(
                        `http://217.196.51.115.site/m/api/images?filePath=guide-pics/${encodeURIComponent(currentSrc)}`
                    );
